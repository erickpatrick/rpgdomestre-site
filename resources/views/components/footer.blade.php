    ...
    <footer class="bg-white" aria-labelledby="footer-heading">
        ...
        <div class="mx-auto max-w-6xl pb-8 pt-16 sm:pt-24 lg:pt-32">
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                ...
                <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            <h3 class="text-sm font-semibold leading-6 text-gray-900">Artigos</h3>
                        ...
                        <div class="mt-10 md:mt-0">
                            <h3 class="text-sm font-semibold leading-6 text-gray-900">Alter Ego</h3>
                            <ul role="list" class="mt-6 space-y-4">
                                <li>
                                    <a href="/alter-ego"
                    ...
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        ...
                        <div class="mt-10 md:mt-0">
                            <h3 class="text-sm font-semibold leading-6 text-gray-900">Transparência</h3>
                            <ul role="list" class="mt-6 space-y-4">
                                <li>
            ...
            <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
                <p class="text-xs leading-5 text-gray-500">&copy; {{ date('Y') }} RPG do Mestre. Todos os direitos reservados.</p>
            </div>
        </div>
    </footer>
