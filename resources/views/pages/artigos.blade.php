    ...
    <x-container>
        <div class="max-w-6xl mx-auto grid gap-8">
            <div class="flex flex-col gap-4 text-center">
                ...
                <h2 class="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold max-w-4xl mx-auto mb-2 text-center">Artigos</h2>
                <p class="text"></p>
            </div>
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-8 gap-y-16">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <h3 class="block text-lg sm:text-xl md:text-xl lg:text-3xl font-bold">
                        <a class="underline underline-offset-4 decoration-1 hover:decoration-wavy" href="/artigos/{{ $article->slug }}" wire:navigate>{{ $article->title }}</a>
                    </h3>
